...
function App() {
  ...
  const generate = async (e) => {
    ...
    const promptRes = await fetch("https://daspartho-prompt-extend.hf.space/api/predict", {
      method: "POST",
      headers: {
    ...
    if (promptRes) {
      ...
      const response = await fetch("https://api.stability.ai/v1/generation/stable-diffusion-v1-5/text-to-image", {
        ...
        headers: {
          "Content-Type": "application/json",
          "Authorization": "sk-dUgP0fk9HgAHX7yLADMOvD9YCOgPuSPDMwYLJKP3RDlWn44m"
        },
  ...
  return (
    <>
      ...
      <div className="main">
        ...
        {imageR && <img alt="img" style={{ height: "500px", width: "500px" }} src={imageR.src} />}
      </div>
    </>
  );
}
